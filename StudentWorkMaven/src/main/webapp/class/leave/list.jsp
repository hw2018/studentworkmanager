...
<body>
	...
	<h5 align="left">查询请假信息：</h5>
<form name="form1" method="post" onsubmit="" action="search_classLeave.action" style="padding:15px;border:thin dashed black;">
<table><tr>
<td>
<div>请假编号：<input class="text-input medium-input" name="body" id="name1" type="text" maxlength="100" size="30" /></div><br/>
