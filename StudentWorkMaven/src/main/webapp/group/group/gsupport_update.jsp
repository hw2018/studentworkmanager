...
<% 
	...
	<div class="content-box-content">
		<form name="form1" action="group/updateGroupSupport.action?type=1" method="post"
			onSubmit="return checkNull()">
			<p>
				赞助商：<input class="text-input large-input" type="text"
					name="groupSupport.name" value="<%=groupSupport.getName()%>"></input>
			</p>
			<p>
			...
			<p>
				...
				<textarea class="text-input textarea"  rows="16" cols="50"
					name="groupSupport.text" ><%=groupSupport.getText()%></textarea>
			</p>
